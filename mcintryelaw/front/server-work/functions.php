...
function theme_styles() {
    ...
    wp_enqueue_style( 'app', get_stylesheet_directory_uri() . '/assets/css/common.css', array() , $verRnd, false);

    wp_enqueue_script( 'jquery', get_stylesheet_directory_uri() . '/assets/js/vendor/jquery.min.js', array(), $verRnd, false );
    //wp_enqueue_script( 'slick', get_stylesheet_directory_uri() . '/assets/js/vendor/slick.min.js', array(), CHILD_THEME_VERSION, false );
    wp_enqueue_script( 'custom-js', get_stylesheet_directory_uri() . '/assets/js/custom.js', array(), $verRnd, true );
